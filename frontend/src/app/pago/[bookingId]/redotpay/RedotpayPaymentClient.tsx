...
import { CheckCircle2, AlertCircle, Loader2, ArrowLeft, Copy, CreditCard, Check } from "lucide-react";
...
export default function RedotpayPaymentClient() {
  ...
  const redotpayInfo = payment.redotpay || {};

  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50">
      <Navbar />
      <div className="relative bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-2 drop-shadow-lg">Pago con Redotpay</h1>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl p-8 mb-6 border border-gray-100 transform hover:shadow-3xl transition-all duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200">
                <p className="text-sm font-semibold text-purple-600 uppercase tracking-wider mb-2">Monto Total</p>
                <p className="text-3xl font-extrabold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">{amount.toLocaleString()} {payment.currency || "MAD"}</p>
              </div>
            </div>
          </div>
          <div className="bg-white rounded-2xl shadow-2xl p-8 mb-6 border border-gray-100 overflow-hidden">
            <div className="flex items-center gap-4 mb-6 pb-6 border-b-2 border-gray-100">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Instrucciones de Pago Redotpay</h2>
                ...
                <div className="space-y-5">
                  <div className="p-4 bg-white rounded-xl border border-purple-100 shadow-sm">
                    <p className="text-xs font-bold text-purple-600 uppercase tracking-wider mb-2 flex items-center gap-2">
                      ...
                      ID de Cuenta Redotpay
                    </p>
                    <div className="flex items-center justify-between gap-3">
                      <p className="font-mono text-xl font-bold text-gray-900 break-all">{redotpayInfo.accountId || "1764625181"}</p>
                      <button onClick={() => copyToClipboard(redotpayInfo.accountId || "1764625181")} className="flex-shrink-0 p-3 rounded-xl bg-purple-100 hover:bg-purple-200 text-purple-600 transition-all duration-200 hover:scale-110 shadow-md" title="Copiar">
                        <Copy className="w-5 h-5" />
                      </button>
                    </div>
                  </div>
                  <div className="p-5 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl shadow-lg border-2 border-purple-300">
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-5 shadow-md">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-800">Una vez realizado el pago, marca como pagado y nuestro equipo verificará la transacción <strong className="font-bold">inmediatamente</strong>.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b-2 border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Marca tu pago como completado</p>
                </div>
              </div>
              <div className="space-y-5">
                {error && (
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-5 shadow-md">
                  <p className="text-xs text-blue-800 text-center leading-relaxed"><strong className="font-bold">Confirmación Instantánea:</strong> Al hacer clic en "Marcar como Pagado", tu pago será enviado a revisión. La administración confirmará el pago <strong className="font-bold">inmediatamente</strong> una vez verificado el ingreso.</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-300 rounded-2xl p-8 shadow-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-yellow-800 leading-relaxed">Tu pago ha sido marcado como realizado y está siendo revisado por la administración. Recibirás una notificación cuando se confirme el pago <strong className="font-bold">inmediatamente</strong>.</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 rounded-2xl p-8 shadow-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-800 leading-relaxed">Tu pago ha sido confirmado exitosamente. Tu reserva está confirmada y lista.</p>
                </div>
              </div>
            </div>
          )}
