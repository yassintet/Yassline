  ...
  const loadVehicle = useCallback(async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        setFormData({
          name: vehicle.name || "",
          type: vehicle.type || "v-class",
          capacity: {
            passengers: vehicle.capacity?.passengers?.toString() || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setError(response.error || "Error al actualizar el vehículo");
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-[var(--yass-cream)]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-6">Editar Vehículo</h1>
